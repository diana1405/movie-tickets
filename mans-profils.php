...
<html lang="lv">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/css/mans-profils.css">
    ...
    <header>
        ...
        <h1>Mans profils</h1>
        <div class="container">
            <div><p>Vārds:</p><p><?=$_COOKIE['name']?></p></div>
            <div><p>Uzvārds:</p><p><?=$_COOKIE['surname']?></p></div>
            <div><p>Dzimšanas datums:</p><p><?=$_COOKIE['date']?></p></div>
            <div><p>Tālrunis:</p><p>+371 <?=$_COOKIE['phone']?></p></div>
            <div><p>E-mail:</p><p><?=$_COOKIE['user']?></p></div>
        </div>

        <div id="dzest">
        <a href="rediget-mans-profils.php?id=<?php echo $_COOKIE['user']?>">
                            <button>Rediģēt</button>
        </a>
        <a href="delete-lietotaju.php?id=<?php echo $_COOKIE['user']?>">
                            <button>Dzēst</button>
        </a>
        </div>
